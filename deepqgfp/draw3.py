...
class Example():
    def __init__(self): 
        ...
        tklbl0 = tk.Label(text='Deep-dGFP Real-time Analysis', font='bold')
        ...
        tklbl10 = tk.Label(text='Droplet number of current frame')
        tklbl10.place(x=xpad+10, y=h*3//4+h//20)
        tklbl4 = tk.Label(text='Droplet diameter (pixels)')
        ...
        def show():
            ...
            if next(cap, None) is not None:
                ...
                tklbl11.config(text="%d"%(len(points)))
