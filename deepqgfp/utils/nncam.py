...
NNCAM_FRAMEINFO_FLAG_SEQ            = 0x01   # frame sequence number
NNCAM_FRAMEINFO_FLAG_TIMESTAMP      = 0x02   # timestamp
NNCAM_FRAMEINFO_FLAG_EXPOTIME       = 0x04   # exposure time
NNCAM_FRAMEINFO_FLAG_EXPOGAIN       = 0x08   # exposure gain
NNCAM_FRAMEINFO_FLAG_BLACKLEVEL     = 0x10   # black level
NNCAM_FRAMEINFO_FLAG_SHUTTERSEQ     = 0x20   # sequence shutter counter
...
NNCAM_IOCONTROLTYPE_GET_EXPO_ACTIVE_MODE      = 0x2f  # 0 => specified lines, 1 => common exposure time, default: 0
